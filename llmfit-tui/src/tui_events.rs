...
use crate::tui_app::{App, AppTab, InputMode};
...
fn handle_normal_mode(app: &mut App, key: KeyEvent) {
    ...
    match key.code {
        ...
        // Tab navigation
        KeyCode::F(1) => app.active_tab = AppTab::LocalFit,
        KeyCode::F(2) => {
            app.active_tab = AppTab::Agents;
            app.fetch_agents();
        },
        KeyCode::F(3) => app.active_tab = AppTab::CloudBench,
        KeyCode::F(4) => app.active_tab = AppTab::PowerTools,
