...
Open an [issue](https://github.com/GangNiaga/llmfit/issues) with:
...
Start a [discussion](https://github.com/GangNiaga/llmfit/discussions) or open an issue. We're happy to chat about ideas before you invest time coding.
